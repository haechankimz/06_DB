...
/* UTF-8 : 영어, 숫자, 기본 특수 문자 == 1BYTE
 * 나머지 == 3BYTE
 */

-- 아이디	 : MEMBER_ID 	 / 자료형 : CHAR/VARCHAR2(20)
-- 비밀번호 : MEMBER_PW 	 / 자료형 : CHAR/VARCHAR2(20)
...
INSERT INTO MEMBER 
VALUES ('MEMO1', '123ABC', '홍길동', '990102-1234567',
	TO_DATE('2024-03-06') );
...
-- ORA-00001: 무결성 제약 조건(KH_KHC.USER_ID_U)에 위배됩니다
...
--> USER_NO가 다름
--> ORA-00001: 무결성 제약 조건(KH_KHC.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_KHC.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_KHC"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_KHC.PK_USERNO_USERID)에 위배됩니다
...
--  ORA-01400: NULL을 ("KH_KHC"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
----------------------------------------------------------------------------------------------------------------
...
-- ORA-02291: 무결성 제약조건(KH_KHC.GRADE_CODE_FK1)이 위배되었습니다
-- - 부모 키가 없습니다
...
DELETE FROM USER_GRADE 
WHERE GRADE_CODE = '30';
-- ORA-02292: 무결성 제약조건(KH_KHC.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
...
--> NOT NULL 제약조건을 제외한 다른 제약 조건은 복사 X
